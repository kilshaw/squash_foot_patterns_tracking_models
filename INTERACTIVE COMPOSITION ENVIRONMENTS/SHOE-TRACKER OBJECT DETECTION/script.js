wimport DeviceDetector from "https://cdn.skypack.dev/device-detector-js@2.2.10";
...
function testSupport(supportedDevices) {
    ...
    if (!isSupported) {
        alert(`Squash Ghosting Footwork Patterns, tracking
            velocity, rotation, axes position, distance.`);
    }
}
...
//        },
        {
            name: 'Ryling_and_Powers_microcycles',
           src: '/Ryland_and_Powers_microcycles.mp4'
        },
        { name: 'Karim Gawads Duet', src: '/karimnoaudio.mp4' },
 { name: 'Aled Back corners', src: '/Aled.mp4' },

        {
            name: 'Simon six Microcycles ',
           src: '/shoes.mp4'
        }
    ],
};
...
//  console.log(landmarks);
 var jay = JSON.stringify(landmarks);
 console.log(jay);
...
new controls
    ...
    selfieMode: false,
    modelName: 'SGFP Model',
    maxNumObjects: 2,
    minDetectionConfidence: 0.05,
    minTrackingConfidence: 0.06,
})
    .add([
    new controls.StaticText({ title: 'SGFP Footwork tracker' }),
    fpsControl,
